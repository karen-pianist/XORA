...
export const faq = [
  {
    ...
    answer:
      "Xora is built to be simple from the start. Upload your footage, choose what you want to create, and let Xora's AI handle the tedious parts of editing. You don't need professional editing experience to get started.",
  },
  {
    id: "1",
    question: "Can I integrate Xora with other platforms?",
    answer:
      "Yes. Xora is designed to fit into your existing workflow. You can import your video assets and export finished projects for use with other creative and publishing platforms.",
  },
  {
    id: "2",
    question: "How often do you add new content?",
    answer:
      "We regularly add new templates, editing tools, AI capabilities, and other content to Xora. New features are introduced as the platform continues to evolve.",
  },
  {
    id: "3",
    question: "What is your refund policy?",
    answer:
      "If you decide Xora isn't right for you, you can request a refund according to the terms of your subscription. Your plan's specific refund conditions will apply.",
  },
  {
    id: "4",
    question: "Do you have corporate plans?",
    answer:
      "Yes. Xora offers plans for teams and organizations that need shared projects, additional storage, collaboration tools, and a more scalable video editing workflow.",
  },
  {
    id: "5",
    question: "What happens when I’m out of storage?",
    answer:
      "When you reach your storage limit, you can free up space by removing files you no longer need or upgrade your plan for additional storage. Your existing projects won't simply disappear.",
  },
  {
    id: "6",
    question: "Can I upgrade my plan?",
    answer:
      "Absolutely. You can upgrade whenever you need more storage, projects, or advanced features. Your upgraded plan gives you access to its additional benefits according to your subscription terms.",
  },
  {
    id: "7",
    question: "How do I invite my team?",
    answer:
      "Open your workspace settings and use the team invitation option. Enter the email addresses of the people you want to invite, and they'll receive instructions for joining your Xora workspace.",
  },
  {
    id: "8",
    question: "Do you offer training for individuals and teams?",
    answer:
      "Xora is designed to be easy to learn, but we also provide guides, documentation, and resources to help individuals and teams get the most out of its AI-powered editing tools.",
  },
  {
    id: "9",
    question: "I'm locked out of my account. What do I do?",
    answer:
      "Use the password recovery option on the sign-in page to regain access to your account. If you're still having trouble signing in, contact Xora support for help recovering your account.",
  },
];
